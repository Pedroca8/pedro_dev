...
export function NotFound(){
    return(
        <section className=" flex flex-col items-center justify-center bg-[#DAD8D4] w-full min-h-screen h-dvh">
            <div className="flex flex-col lg:flex-row">
                <div className=" text-center lg:text-left max-w-md mb-10 lg:mb-0">
                <h1 className="text-2xl font-bold text-gray-900 mb-4 lg:text-8xl">404</h1>
